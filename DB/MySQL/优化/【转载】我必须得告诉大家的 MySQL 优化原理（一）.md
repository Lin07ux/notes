> 转载：[我必须得告诉大家的MySQL优化原理 - CHEN川](http://www.jianshu.com/p/d7665192aaaf)
...
![MySQL 逻辑架构图](http://cnd.qiniu.lin07ux.cn/markdown/1501049295257.png)
...
![](http://cnd.qiniu.lin07ux.cn/markdown/1501049513529.png)
...
![二叉查找树和平衡二叉树](http://cnd.qiniu.lin07ux.cn/markdown/1501051003282.png)
...
![平衡二叉树旋转](http://cnd.qiniu.lin07ux.cn/markdown/1501051083338.png)
...
![](http://cnd.qiniu.lin07ux.cn/markdown/1501051236381.png)
...
![leaf page 和 index page 都没有满](http://cnd.qiniu.lin07ux.cn/markdown/1501051521691.png)

接着插入下一个节点 70，在 Index Page 中查询后得知应该插入到 50 - 70 之间的叶子节点，但叶子节点已满，这时候就需要进行也分裂的操作，当前的叶子节点起点为 50，所以根据中间值来拆分叶子节点，如下图所示。

![Leaf Page 拆分](http://cnd.qiniu.lin07ux.cn/markdown/1501051585108.png)

最后插入一个节点 95，这时候 Index Page 和 Leaf Page 都满了，就需要做两次拆分，如下图所示。

![Leaf Page 与 Index Page 拆分](http://cnd.qiniu.lin07ux.cn/markdown/1501051638329.png)

拆分后最终形成了这样一颗树：

![最终树](http://cnd.qiniu.lin07ux.cn/markdown/1501051671696.png)
...
![左旋操作](http://cnd.qiniu.lin07ux.cn/markdown/1501051786182.png)
...
![索引如何组织数据存储，来自：高性能 MySQL](http://cnd.qiniu.lin07ux.cn/markdown/1501051905502.png)
